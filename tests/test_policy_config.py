    ...
    path.write_text(
        "\n".join(
            (
                ...
                "",
                "[providers.agy]",
                f"enabled = {str(agy_enabled).lower()}",
                f"priority = {agy_priority}",
                f'default_model = "{agy_model}"',
                "",
                "[providers.codex]",
                f"enabled = {str(codex_enabled).lower()}",
                f"priority = {codex_priority}",
                f'default_model = "{codex_model}"',
                "",
                "[providers.claude]",
                f"enabled = {str(claude_enabled).lower()}",
                f"priority = {claude_priority}",
                f'default_model = "{claude_model}"',
                "",
                "[providers.cursor]",
                ...
                "",
                "[providers.ollama]",
                f"enabled = {str(ollama_enabled).lower()}",
                f"priority = {ollama_priority}",

...
- [ ] AC-03: ./scripts/verify and protected exact-head publication pass. Coding Agent authors the implementation on this existing PR; independent Validator owns merge.

The initial draft contains failing regressions only. Do not remove or weaken them. No model route, provider, credential, attempt or spending budget changes. Evidence belongs in the [canonical autonomy receipt](https://github.com/subactor/docs/blob/main/architecture/analysis/autonomy-execution-receipt.md).

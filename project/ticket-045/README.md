...
Scope and acceptance are in intent.json. Canonical evidence and limitations: [assessment latency](../../docs/analysis/supervisor-assessment-latency.md). No new provider, model, credential, grant or execution authority.
